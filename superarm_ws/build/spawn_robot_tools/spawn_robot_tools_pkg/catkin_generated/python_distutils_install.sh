...
echo_and_run cd "/home/star/superarm_ws/src/spawn_robot_tools/spawn_robot_tools_pkg"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/star/superarm_ws/build/spawn_robot_tools/spawn_robot_tools_pkg" \
    install \
    $DESTDIR_ARG \
